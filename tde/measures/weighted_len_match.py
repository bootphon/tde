...
def eval_from_psets(pdisc, pgold, psubs, verbose=False, debug=False):
    ...
    if len(psubs_nmatch) == 0:
        ...
        prec = sum(len(t) * ws_disc[t] * psubs_pgold_nmatch[t] / psubs_nmatch[t]
                   for t in ts_disc) / len_disc
    ...
    if len(pgold_nmatch) == 0:
        ...
        rec = sum(len(t) * ws_gold[t] * psubs_pgold_nmatch[t] / pgold_nmatch[t]
                  for t in ts_disc) / len_gold
